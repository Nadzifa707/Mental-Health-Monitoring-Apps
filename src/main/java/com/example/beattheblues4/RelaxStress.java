...
public class RelaxStress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relax_stress);
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String videopath = "android.resource://com.example.beattheblues4/"+ R.raw.stress;
